 ...
 *
 * 환경변수에 Google redirect URI가 있으면 그 값을 우선 사용하고,
 ...
 */
export function getAuthRedirectUri(provider: "google") {
  const configuredRedirectUri = process.env.EXPO_PUBLIC_GOOGLE_REDIRECT_URI;
